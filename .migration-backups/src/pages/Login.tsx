        ...
        >
            ...
            <LoginContainer maxWidth="sm">
                <LoginCard>
                    ...
                    <Box component="form" onSubmit={handleEmailPasswordSignIn} sx={{ mt: 2 } as any}>
                        <TextField
                            fullWidth
                            label="Email"
                            type="email"
                            value={email}
                            onChange={(e: any) => (e) => (e) => (e) => (e) => (e) => setEmail(e.target.value)}
                            margin="normal"
                            required
                        />
                        <TextField
                            ...
                            type="password"
                            value={password}
                            onChange={(e: any) => (e) => (e) => (e) => (e) => (e) => setPassword(e.target.value)}
                            margin="normal"
                            required
                        />
                        <Button
                    ...
                    {/* Divider  
                    <Box sx={{ display: 'flex', alignItems: 'center', my: 2 } as any}>
                        <Box sx={{ flexGrow: 1, height: '1px', backgroundColor: theme.palette.divider } as any} />
                        <Typography variant="body2" sx={{ mx: 2, color: theme.palette.text.secondary } as any}>
                            OR
                        </Typography>
                        <Box sx={{ flexGrow: 1, height: '1px', backgroundColor: theme.palette.divider } as any} />
                    </Box>
 */}
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' } as any}>
                        <GoogleButton
                            fullWidth
                            variant="outlined"
