...
const GridTestPage = () => {
  ...
  const handleImportConfig = useCallback((event as any) => {
  ...
  return (
    <Box sx={{ p: 3, height: '100%', overflow: 'auto' } as any}>
      {/* Header */}
      <Box sx={{ mb: 4 } as any}>
        <Typography variant="h4" sx={{ mb: 1, fontWeight: 600 } as any}>
          Grid Testing System
        </Typography>
      ...
      <Grid {...{container: true}} spacing={3}>
        ...
        <Grid {...{item: true}} xs={12} md={4}>
          <Card>
                  ...
                  <Tooltip title="Import Config">
                    <IconButton component="label" size="small">
                      ...
                      <input
                        ...
                        accept=".json"
                        hidden
                        onChange={(e) => (e) => (e) => (e) => (e) => handleImportConfig}
                      />
                    </IconButton>
                  </Tooltip>
            ...
            <CardContent>
              {/* Grid Type Selection */}
              <FormControl fullWidth sx={{ mb: 3 } as any}>
                <InputLabel>Grid Type</InputLabel>
                <Select
                  value={selectedGridType}
                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => setSelectedGridType(e.target.value)}
                  label="Grid Type"
                >
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) => (e) => (e) => (e) => (e) => (e) => handleConfigChange('showStatsCards', e.target.checked)}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) => (e) => (e) => (e) => (e) => (e) => handleConfigChange('enableVirtualization', e.target.checked)}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) => (e) => (e) => (e) => (e) => (e) => handleConfigChange('enableSearch', e.target.checked)}
                        />
                      }
                      label="Enable Search"
                    />
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) => (e) => (e) => (e) => (e) => (e) => handleConfigChange('enableToolbar', e.target.checked)}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) => (e) => (e) => (e) => (e) => (e) => handleConfigChange('enablePagination', e.target.checked)}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) => (e) => (e) => (e) => (e) => (e) => handleConfigChange('enableSelection', e.target.checked)}
                        />
                      }
                ...
                <AccordionDetails>
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 } as any}>
                    <TextField
                      ...
                      onChange={(e) => (e) => (e) => (e) => (e) => (e) => handleConfigChange('pageSize', parseInt(e.target.value) || 25)}
                      size="small"
                    />
                    <FormControl size="small">
                      ...
                      <Select
                        ...
                        onChange={(e) => (e) => (e) => (e) => (e) => (e) => handleConfigChange('density', e.target.value)}
                        label="Density"
                      >
        ...
        <Grid {...{item: true}} xs={12} md={8}>
          <Card sx={{ height: 'calc(100vh - 200px)' } as any}>
            <CardHeader
              title={
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 } as any}>
                  <GridView />
            ...
            />
            <CardContent sx={{ height: 'calc(100% - 80px)', p: 1 } as any}>
              <UnifiedGrid
