...
const Dashboard = () => {
  ...
  const handleSettingsChange = (newSettings) => {
    ...
    try {
      ...
      localStorage.setItem('dashboardSettings', JSON.stringify(newSettings as any));
    }
  };
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      ...
      >
        ...
        >
          <Box sx={{ 
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 } as any}>
              <DashboardIcon sx={{ fontSize: 32, color: 'primary.main' } as any} />
              <Typography variant="h4" sx={{ fontWeight: 700, color: 'primary.main' } as any}>
                {translate('navigation.dashboard') || 'Dashboard'}
              </Typography>
            </Box>
            
            <Box sx={{ display: 'flex', gap: 1, alignItems: 'center', flexWrap: 'wrap' } as any}>
              {/* Date Range Pickers */}
              <Box sx={{ 
                display: 'flex', 
                gap: 1, 
                ...
                <DatePicker
                  ...
                  value={startDate}
                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setStartDate}
                  slotProps={{ textField: { size: 'small', sx: { width: 140 } } }}
                />
                <DatePicker
                  label={translate('dashboard.endDate') || 'End Date'}
                  value={endDate}
                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setEndDate}
                  slotProps={{ textField: { size: 'small', sx: { width: 140 } } }}
                />
              </Box>
        ...
        {error && (
          <Paper sx={{ p: 3, borderRadius: 3, bgcolor: 'error.light', color: 'error.contrastText' } as any}>
        ...
        {!loading && !error && (
          <>
            ...
            <Grid {...{container: true}} spacing={3} sx={{ mb: 4 } as any}>
            ...
            <Grid {...{container: true}} spacing={3}>
              ...
              <Grid size={{ xs: 12, lg: 8 }}>
                ...
                {dashboardSettings.charts.orders && (
                  <Card sx={{ mt: 3, borderRadius: 3 } as any}>
                    <CardContent>
            ...
            <Box sx={{ mt: 4 } as any}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 } as any}>
        ...
        <Box sx={{
          ...
          <Typography variant="caption" color="text.secondary" display="block" sx={{ mt: 0.5 } as any}>
