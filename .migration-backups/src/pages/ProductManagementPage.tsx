...
const ProductManagementPage = () => {
  ...
  return (
    <Box sx={{ height: '100vh', display: 'flex', flexDirection: 'column', p: 2 } as any}>
      {/* Enhanced Header */}
      

      {/* Enhanced Tabs */}
      <Paper sx={{ borderRadius: 3, overflow: 'hidden', mb: 3 } as any}>
        <Tabs
          value={activeTab}
          onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e, newValue) => setActiveTab(newValue)}
          variant="fullWidth"
          sx={{
      ...
      <Box sx={{ flexGrow: 1 } as any}>
        {/* Tab Panel Component */}
        {activeTab === 0 && (
          <Paper sx={{ p: 3, borderRadius: 3, height: '100%' } as any}>
            ...
            <>
              ...
              <Box sx={{ display: 'flex', gap: 2, mb: 2 } as any}>
                <TextField
                  label="Product ID"
                  value={inputValue}
                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => setInputValue(e.target.value)}
                  onKeyPress={handleKeyPress}
                  placeholder="Enter product ID (e.g., 1140659762)"
                  size="small"
                  sx={{ minWidth: 200 } as any}
                />
                <Button
                  variant="contained"
          ...
          {showAllProducts && (
            ...
            {/* Main Content */}
            <Box sx={{ flexGrow: 1, overflow: 'hidden', mt: 2 } as any}>
        ...
        {activeTab === 1 && (
          <Paper sx={{ p: 3, borderRadius: 3, height: '100%' } as any}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 } as any}>
              Rename camera images with ref attributes to longer descriptive names using CSV mapping
            </Typography>

            <Grid {...{container: true}} spacing={3}>
              <Grid {...{item: true}} xs={12} md={6}>
                <Card sx={{ p: 3, textAlign: 'center' } as any}>
                  <RenameIcon sx={{ fontSize: 48, color: 'primary.main', mb: 2 } as any} />
                  <Typography variant="h6" gutterBottom>
                    Rename Images
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 3 } as any}>
        ...
        {activeTab === 2 && (
          <Paper sx={{ p: 3, borderRadius: 3, height: '100%' } as any}>
            ...
            <Grid {...{container: true}} spacing={3}>
              <Grid {...{item: true}} xs={12} md={6}>
                <Card sx={{ p: 3, textAlign: 'center' } as any}>
                  <ResizeIcon sx={{ fontSize: 48, color: 'info.main', mb: 2 } as any} />
                  <Typography variant="h6" gutterBottom>
                    Resize Images
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 3 } as any}>
          ...
          <Paper sx={{ p: 3, borderRadius: 3, height: '100%' } as any}>
            ...
            <Grid {...{container: true}} spacing={3}>
              <Grid {...{item: true}} xs={12} md={4}>
                <Card sx={{ p: 3, textAlign: 'center' } as any}>
                  <CategoryIcon sx={{ fontSize: 48, color: 'success.main', mb: 2 } as any} />
                  <Typography variant="h6" gutterBottom>
                    Categories
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 } as any}>
              ...
              <Grid {...{item: true}} xs={12} md={4}>
                <Card sx={{ p: 3, textAlign: 'center' } as any}>
                  <BrandIcon sx={{ fontSize: 48, color: 'warning.main', mb: 2 } as any} />
                  <Typography variant="h6" gutterBottom>
                    Brands
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 } as any}>
              ...
              <Grid {...{item: true}} xs={12} md={4}>
                <Card sx={{ p: 3, textAlign: 'center' } as any}>
                  <SettingsIcon sx={{ fontSize: 48, color: 'secondary.main', mb: 2 } as any} />
                  <Typography variant="h6" gutterBottom>
                    Attributes
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 } as any}>
