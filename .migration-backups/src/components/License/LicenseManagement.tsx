                            ...
                            <AccordionDetails>
                                <Grid {...{container: true}} spacing={2}>
                                    {category.children?.map((menuItem) => (
                                        <Grid {...{item: true}} xs={12} md={6} key={menuItem.id}>
                                                    ...
                                                    <Box display="flex" gap={1}>
                                                        <Tooltip title="Can Read">
                                                            <Switch
                                                                ...
                                                                onChange={(e) => (e) => handleLicenseChange(selectedUser?.uid, { canRead: e.target.checked })}
                                                        ...
                                                        <Tooltip title="Can Edit">
                                                            <Switch
                                                                ...
                                                                onChange={(e) => (e) => handleLicenseChange(selectedUser?.uid, { canEdit: e.target.checked })}
                                                                disabled={isLocalhost}
                                                            />
                                                        </Tooltip>
                                                        <Tooltip title="Can Delete">
                                                            <Switch
                                                                ...
                                                                onChange={(e) => (e) => handleLicenseChange(selectedUser?.uid, { canDelete: e.target.checked })}
                                                                disabled={isLocalhost}
                                                            />
                                                        </Tooltip>
                                                    </Box>
                                        ...
                                        <Grid {...{item: true}} xs={4}>
                                            <Box textAlign="center">
                                                <Switch
                                                    ...
                                                    onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => handleLicenseChange(selectedUser?.?.?..uid, { canRead: e.target.checked })}
                                                />
                                        ...
                                        <Grid {...{item: true}} xs={4}>
                                            <Box textAlign="center">
                                                <Switch
                                                    ...
                                                    onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => handleLicenseChange(selectedUser?.?.?..uid, { canEdit: e.target.checked })}
                                                />
                                                <Typography variant="caption" display="block">
                                                    Can Edit
                                                </Typography>
                                        ...
                                        <Grid {...{item: true}} xs={4}>
                                            <Box textAlign="center">
                                                <Switch
                                                    ...
                                                    onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => handleLicenseChange(selectedUser?.?.?..uid, { canDelete: e.target.checked })}
                                                />
                                                <Typography variant="caption" display="block">
                                                    Can Delete
                                                </Typography>
