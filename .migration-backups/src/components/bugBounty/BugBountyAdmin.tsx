        ...
        <DialogContent>
          ...
          <Box sx={{ mt: 3 }}>
            ...
            <FormControl fullWidth sx={{ mb: 2 }}>
              ...
              <Select
                value={newStatus}
                onChange={(e: any) => (e: any) => (e: any) => setNewStatus(e.target.value)}
              >
            ...
            <Box sx={{ mb: 2 }}>
              ...
              <Rating
                value={qualityScore}
                onChange={(e: any) => (e: any) => (event, newValue) => setQualityScore(newValue || 3)}
                max={5}
              />
            ...
            <TextField
              ...
              label="Admin Notes"
              value={adminNotes}
              onChange={(e: any) => (e: any) => (e: any) => setAdminNotes(e.target.value)}
        ...
        <DialogContent>
          <Box sx={{ mb: 2 }}>
            <FormControl sx={{ minWidth: 200 }}>
              ...
              <Select
                value={filter}
                onChange={(e: any) => (e: any) => (e: any) => setFilter(e.target.value)}
              >
          ...
          <TableContainer component={Paper}>
            <Table>
              ...
              <TableBody>
                {bugs.map((bug) => (<TableRow key={bug.id}>
                    <TableCell>
