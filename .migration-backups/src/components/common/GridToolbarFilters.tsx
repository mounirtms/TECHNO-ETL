 ...
 */
const GridToolbarFilters: React.FC<any> = ({
  customFilters = [],
  currentCustomFilter,
      ...
      {customFilters.length > 0 && (
        <FormControl size="small" sx={{ minWidth: 120 } as any}>
          ...
          <Select
            ...
            onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => onCustomFilterChange?.(e.target?.value)}
        ...
        <FormControlLabel
          control={
            <Switch
              ...
              onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => setShowChangedOnly(e.target.checked)}
              size="small"
            />
          }
