  ...
  return (
    <Box sx={{ 
      ...
      >
        ...
        <Divider orientation="vertical" flexItem sx={{ mx: 1 } as any} />
        ...
        {toolbarConfig.showSearch && (
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, minWidth: 200, maxWidth: 350 } as any}>
            <TextField
              size="small"
              placeholder={translate('search', 'Search ')}
              value={searchText}
              onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => handleSearchChange}
        ...
        {toolbarConfig.showViewToggle && showCardView && (
          <ToggleButtonGroup
            value={viewMode}
            exclusive
            onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => onViewModeChange}
            size="small"
          >
