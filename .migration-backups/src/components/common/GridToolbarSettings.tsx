...
const GridToolbarSettings = ({
  ...
  const handleDensityChange = (newDensity) => {
    onDensityChange?.(newDensity as any);
    onClose();
  };
  ...
  return (
    ...
    >
      ...
      <MenuItem>
        ...
        <Box sx={{ flex: 1 } as any}>
          ...
          <FormControl size="small" fullWidth>
            <Select
              value={density}
              onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => handleDensityChange(e.target.value)}
              variant="outlined"
            >
      ...
      {Object.keys(columnVisibility).length > 0 && (
        <Box sx={{ maxHeight: 200, overflow: 'auto' } as any}>
