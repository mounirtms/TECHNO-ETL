...
const TreeMenuNavigation: React.FC<any> = ({ 
    ...
    const filteredMenuTree = useMemo(() => {
        ...
        MENU_TREE.forEach(category => {
            const matchedChildren = category.children?.filter(item => {
                ...
                return itemText.includes(query as any) || categoryText.includes(query as any);
            }) || [];
    ...
    const renderMenuItem = (item) => {
        ...
        const licenseStatus = getLicenseStatus(item as any);
            ...
            {open && (
                <SearchContainer>
                    <TextField
                        ...
                        value={searchQuery}
                        onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setSearchQuery(e.target.value)}
                        InputProps={{
                            startAdornment: (
