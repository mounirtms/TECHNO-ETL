 ...
 */
export const EnhancedPieChart: React.FC<any> = ({
  data = [],
  title,
  loading = false,
  height = 300,
  ...
  const CustomLabel: React.FC<any> = ({ cx, cy, midAngle, innerRadius, outerRadius, percent, name }) => {
      ...
      <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' } as any}>
        <CardContent sx={{ pb: 1 } as any}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 } as any}>
            <Box>
              <Typography variant="h6" sx={{ fontWeight: 600, mb: 0.5 } as any}>
                {title}
              </Typography>
              {subtitle && (
                <Typography variant="body2" color="text.secondary">
          ...
          {/* Summary Stats */}
          <Stack direction="row" spacing={1} sx={{ mb: 2, flexWrap: 'wrap' } as any}>
            <Chip
 ...
 */
export const EnhancedBarChart: React.FC<any> = ({
  data = [],
  title,
  loading = false,
  height = 300,
 ...
 */
export const EnhancedLineChart: React.FC<any> = ({
  data = [],
  title,
  loading = false,
  height = 300,
    ...
    >
      <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' } as any}>
        <CardContent sx={{ pb: 1 } as any}>
          ...
          {/* Trend Indicator */}
          {showTrend && trend && (
            <Stack direction="row" spacing={1} sx={{ mb: 2 } as any}>
              <Chip
