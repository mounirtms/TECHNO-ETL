...
const GridFilterSettings: React.FC<any> = ({ user, onSettingsChange }) => {
  ...
  const handleEditPreset = (preset) => {
    setEditingPreset(preset as any);
    setNewPreset({ ...preset });
      ...
      case 'number':
          ...
          return (
            <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' } as any}>
              <TextField
                ...
                onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => handleUpdateFilter(filter?.?..id, {
        ...
        return (
          <TextField
            ...
            placeholder="Value"
            value={filter.value || ''}
            onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => handleUpdateFilter(filter?.?..id, { value: e.target.value })}
          />
        );
            ...
            <LocalizationProvider dateAdapter={AdapterDateFns}>
              <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' } as any}>
                <DatePicker
                  ...
                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (date) => handleUpdateFilter(filter?.?..id, {
        ...
        return (
          <LocalizationProvider dateAdapter={AdapterDateFns}>
            <DatePicker
              ...
              onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (date) => handleUpdateFilter(filter?.?..id, { value: date })}
              renderInput={(params) => <TextField {...params} size="small" />}
            />
          </LocalizationProvider>
        );
      ...
      <Card sx={{ mb: 3 } as any}>
        ...
        <CardContent>
          {Object.values(filterPresets).length === 0 ? (
            ...
            <List>
              {Object.values(filterPresets).map((preset as any) => (
                <ListItem key={preset?.?..id} divider>
                  ...
                  <ListItemSecondaryAction>
                    <Tooltip title="Edit Preset">
                      <IconButton onClick={() => handleEditPreset(preset as any)}>
                        <Edit />
                      </IconButton>
                    </Tooltip>
        ...
        <DialogContent>
          <Grid {...{container: true}} spacing={2} sx={{ mt: 1 } as any}>
            <Grid {...{item: true}} xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setNewPreset(prev => ({ ...prev, name: e.target.value }))}
                required
              />
            </Grid>
            <Grid {...{item: true}} xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setNewPreset(prev => ({ ...prev, gridType: e.target.value }))}
                  label="Grid Type"
                >
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setNewPreset(prev => ({ 
                    ...prev, 
          ...
          <Box sx={{ mb: 2 } as any}>
            ...
            {newPreset.filters.map((filter, index) => (
              <Card key={filter?.?..id} sx={{ mb: 2, p: 2 } as any}>
                  ...
                  <Grid {...{item: true}} xs={12} md={3}>
                    <FormControl fullWidth size="small">
                      ...
                      <Select
                        ...
                        onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => handleUpdateFilter(filter?.?..id, { operator: e.target.value })}
                        label="Operator"
                      >
