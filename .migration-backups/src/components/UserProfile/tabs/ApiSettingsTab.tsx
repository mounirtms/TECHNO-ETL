...
const ApiSettingsTab = () => {
    ...
    return (
        <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 } as any}>
            {/* Header */}
            <Box sx={{ mb: 4 } as any}>
            ...
            <Accordion 
                ...
                onChange={(e) => (e) => (e) => (e) => (e) => (e) => () => setExpandedSection(expandedSection === 'magento' ? null : 'magento')}
                sx={{ 
                    mb: 2, 
                    boxShadow: 2,
                    '&:before': { display: 'none' },
                                    ...
                                    <Grid {...{container: true}} spacing={2}>
                                        <Grid size={{ xs: 12, md: 8 }}>
                                            <TextField
                                                ...
                                                onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => handleInputChange('magento', 'url', e.target.value)}
                                        ...
                                        <Grid size={{ xs: 12, md: 4 }}>
                                            <FormControl fullWidth size="small">
                                                ...
                                                <Select
                                                    ...
                                                    onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => handleInputChange('magento', 'authMode', e.target.value)}
                                                ...
                                                <Grid {...{container: true}} spacing={2}>
                                                    <Grid size={{ xs: 12, sm: 6 }}>
                                                        <TextField
                                                            ...
                                                            onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => handleInputChange('magento', 'username', e.target.value)}
                                                        />
                                                    </Grid>
                                                    <Grid size={{ xs: 12, sm: 6 }}>
                                                        <TextField
                                                            ...
                                                            onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => handleInputChange('magento', 'password', e.target.value)}
                                                        />
                                                    </Grid>
                                                    <Grid size={12}>
                                                        <Button
                                                    ...
                                                    {[
                                                        ...
                                                        <Grid size={{ xs: 12, sm: 6 }} key={key}>
                                                            <TextField
                                                                ...
                                                                onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => handleInputChange('magento', key, e.target.value)}
