    ...
    return (
        <Box sx={{ p: 3 }}>
            ...
            <input
                type="file"
                ref={fileInputRef}
                onChange={(e) => (e) => (e) => handleFileImport}
                accept=".json"
                style={{ display: 'none' }}
            />
            ...
            <Accordion
                ...
                onChange={(e) => (e) => (e) => handleAccordionChange('appearance')}
            >
                            ...
                            <FormControlLabel
                                control={
                                    <Switch
                                        ...
                                        onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'animations', e.target.checked)}
                                    />
                                }
            ...
            <Accordion
                ...
                onChange={(e) => (e) => (e) => handleAccordionChange('performance')}
            >
                <AccordionSummary expandIcon={<ExpandMore />}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Speed color="primary" />
                    ...
                    <Grid container spacing={3}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            ...
                            <Slider
                                ...
                                onChange={(e) => (e) => (e) => (e, value) => handlePreferenceChange('preferences', 'defaultPageSize', value)}
                                min={10}
                                max={100}
                                step={5}
                                marks={[
                        ...
                        <Grid size={{ xs: 12, md: 6 }}>
                            ...
                            <Slider
                                ...
                                onChange={(e) => (e) => (e) => (e, value) => handlePreferenceChange('preferences', 'refreshInterval', value)}
                                min={10}
                                max={300}
                                step={10}
                                marks={[
                                ...
                                <FormControlLabel
                                    control={
                                        <Switch
                                            ...
                                            onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'enableVirtualization', e.target.checked)}
                                        />
                                    }
                                ...
                                <FormControlLabel
                                    control={
                                        <Switch
                                            ...
                                            onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'cacheEnabled', e.target.checked)}
                                        />
                                    }
                                ...
                                <FormControlLabel
                                    control={
                                        <Switch
                                            ...
                                            onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'autoRefresh', e.target.checked)}
                                        />
                                    }
                                ...
                                <FormControlLabel
                                    control={
                                        <Switch
                                            ...
                                            onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'lazyLoading', e.target.checked)}
                                        />
                                    }
            ...
            <Accordion
                ...
                onChange={(e) => (e) => (e) => handleAccordionChange('notifications')}
            >
                <AccordionSummary expandIcon={<ExpandMore />}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            ...
                            <FormControlLabel
                                control={
                                    <Switch
                                        ...
                                        onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'emailNotifications', e.target.checked)}
                                    />
                                }
                            ...
                            <FormControlLabel
                                control={
                                    <Switch
                                        ...
                                        onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'pushNotifications', e.target.checked)}
                                    />
                                }
                            ...
                            <FormControlLabel
                                control={
                                    <Switch
                                        ...
                                        onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'soundEnabled', e.target.checked)}
                                    />
                                }
            ...
            <Accordion
                ...
                onChange={(e) => (e) => (e) => handleAccordionChange('accessibility')}
            >
                <AccordionSummary expandIcon={<ExpandMore />}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            ...
                            <FormControlLabel
                                control={
                                    <Switch
                                        ...
                                        onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'highContrast', e.target.checked)}
                                    />
                                }
                            ...
                            <FormControlLabel
                                control={
                                    <Switch
                                        ...
                                        onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'largeText', e.target.checked)}
                                    />
                                }
                            ...
                            <FormControlLabel
                                control={
                                    <Switch
                                        ...
                                        onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'keyboardNavigation', e.target.checked)}
                                    />
                                }
                            ...
                            <FormControlLabel
                                control={
                                    <Switch
                                        ...
                                        onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'screenReader', e.target.checked)}
                                    />
                                }
            ...
            <Accordion
                ...
                onChange={(e) => (e) => (e) => handleAccordionChange('security')}
            >
                <AccordionSummary expandIcon={<ExpandMore />}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Grid container spacing={3}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            ...
                            <Slider
                                ...
                                onChange={(e) => (e) => (e) => (e, value) => handlePreferenceChange('preferences', 'sessionTimeout', value)}
                                min={5}
                                max={120}
                                step={5}
                                marks={[
                                ...
                                <FormControlLabel
                                    control={
                                        <Switch
                                            ...
                                            onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'twoFactorEnabled', e.target.checked)}
                                        />
                                    }
                                ...
                                <FormControlLabel
                                    control={
                                        <Switch
                                            ...
                                            onChange={(e) => (e) => (e) => (e) => handlePreferenceChange('preferences', 'auditLogging', e.target.checked)}
                                        />
                                    }
