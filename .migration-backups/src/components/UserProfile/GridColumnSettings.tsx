...
const GridColumnSettings: React.FC<any> = ({ user, onSettingsChange }) => {
  ...
  const handleResetToDefaults = (gridType: any) => {
    setColumnSettings(prev => ({
      ...prev,
      [gridType]: {
        columns: gridTypes[gridType].defaultColumns,
  ...
  return (
    <Box sx={{ p: 3 } as any}>
        ...
        <CardContent>
          <FormControl fullWidth sx={{ mb: 2 } as any}>
            ...
            <Select
              ...
              onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => setSelectedGridType(e.target.value)}
          ...
          <Box sx={{ mb: 3 } as any}>
            ...
            <FormControl size="small" sx={{ minWidth: 150 } as any}>
              <Select
                ...
                onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => handleDensityChange(selectedGridType, e.target.value)}
              >
      ...
      <Card>
        ...
        />
        <CardContent>
          <DragDropContext onDragEnd={(result: any) => handleColumnReorder(selectedGridType, result)}>
                        ...
                        >
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 } as any}>
                            ...
                            <TextField
                              ...
                              label="Width"
                              value={column.width}
                              onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => handleColumnWidthChange(
                                selectedGridType, 
                                column.field, 
                            ...
                            <Tooltip title="Pin Column">
                              <Checkbox
                                ...
                                onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => handleColumnPinChange(
                                  selectedGridType, 
                                  column.field, 
                                  e.target.checked
                                )}
