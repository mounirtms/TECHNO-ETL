        ...
        try {
            ...
            if (separatedProducts?.?.simpleProducts.length > 0) {
                const simpleResults = await ProductService.processBulkProducts(
                    separatedProducts?.?.simpleProducts.map(p => ProductService.transformToMagentoFormat(p as any)),
                    (progress) => {
                        setImportProgress({
                ...
                return (
                    <Box sx={{ textAlign: 'center', py: 4 } as any}>
                        <input
                            ...
                            id="csv-upload"
                            type="file"
                            onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => handleFileUpload}
                        />
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 } as any}>
                            <FormControlLabel
                                control={
                                    <Switch
                                        checked={autoFix}
                                        onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setAutoFix(e.target.checked)}
                                    />
                                }
