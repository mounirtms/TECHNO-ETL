...
const CalligraphBulkUploadDialog: React.FC<any> = ({ open, onClose, onComplete }) => {
  ...
  const handleStartUpload = async () => {
    ...
    try {
      const results = await calligraphMediaUploadService.bulkUploadCalligraphImages(
        ...
        (progress as any) => setUploadProgress(progress as any),
        {
  ...
  const downloadResults = () => {
    ...
    const csv = [
      ...
      ...data?..map(row => Object.values(row as any).join(','))
    ].join('\n');
              ...
              {matchingResults && (
                <Box>
                  ...
                  <Paper sx={{ mb: 3 } as any}>
                    <Tabs value={activeTab} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e, v) => setActiveTab(v as any)}>
                      <Tab 
                        label={
                        ...
                        <Grid {...{container: true}} spacing={3}>
                            ...
                            <FormControlLabel
                              control={
                                <Switch
                                  ...
                                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setSettings(prev => ({ ...prev, processImages: e.target.checked }))}
                                />
                              }
                            ...
                            {settings.processImages && (
                              <Box sx={{ mt: 2 } as any}>
                                ...
                                <Slider
                                  ...
                                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e, v) => setSettings(prev => ({ ...prev, targetSize: v }))}
                                  min={800}
                                  max={2000}
                                  step={100}
                                  marks={[
                                ...
                                <Slider
                                  ...
                                  onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e, v) => setSettings(prev => ({ ...prev, imageQuality: v }))}
                                  min={60}
                                  max={100}
                                  step={5}
                                  marks={[
                          ...
                          <Grid {...{item: true}} xs={12} md={6}>
                            ...
                            <Slider
                              ...
                              onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e, v) => setSettings(prev => ({ ...prev, batchSize: v }))}
                              min={1}
                              max={10}
                              step={1}
                              marks={[
                            ...
                            <Slider
                              ...
                              onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e, v) => setSettings(prev => ({ ...prev, delayBetweenBatches: v }))}
                              min={500}
                              max={5000}
                              step={500}
                              marks={[
