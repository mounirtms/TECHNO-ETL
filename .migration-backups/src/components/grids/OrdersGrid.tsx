    ...
    <Box sx={{ p: 3 } as any}>
      ...
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} sx={{ mb: 3 } as any}>
        <TextField
          ...
          value={searchQuery}
          onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => setSearchQuery(e.target.value)}
          InputProps={{
            startAdornment: (
        ...
        <FormControl sx={{ minWidth: 120 } as any}>
          ...
          <Select
            value={statusFilter}
            label="Status"
            onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => setStatusFilter(e.target.value)}
          >
        ...
        <FormControl sx={{ minWidth: 120 } as any}>
          ...
          <Select
            value={sortBy}
            label="Sort By"
            onChange={(e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => (e: any) => setSortBy(e.target.value)}
          >
      ...
      {/* Orders Grid */}
      <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))', gap: 2 } as any}>
        {filteredOrders.map((order) => (
          <Card key={order.id} sx={{ height: 'fit-content' } as any}>
            <CardContent>
              <Stack spacing={2}>
                {/* Order Header */}
      ...
      {filteredOrders.length === 0 && (
        <Box sx={{ textAlign: 'center', py: 4 } as any}>
          <OrderIcon sx={{ fontSize: 64, color: 'text.secondary', mb: 2 } as any} />
