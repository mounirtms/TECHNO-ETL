...
const ProfessionalVotingGrid: React.FC<any> = ({ userId = 'anonymous' }) => {
  ...
  const columns = useMemo(() => [
    {
      ...
      renderCell: (params) => (
        <Box sx={{ py: 1 } as any}>
          <Typography variant="subtitle2" sx={{ fontWeight: 600, mb: 0.5 } as any}>
            {params.value}
          </Typography>
  ...
  return (
    <Box sx={{ height: '100%', width: '100%' } as any}>
        ...
        <Grid {...{container: true}} spacing={2} alignItems="center">
          <Grid {...{item: true}} xs={12} md={3}>
            <TextField
              ...
              onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => setFilterModel(prev => ({ ...prev, search: e.target.value }))}
              InputProps={{
                startAdornment: (
          ...
          <Grid {...{item: true}} xs={12} md={2}>
            <FormControl fullWidth size="small">
              ...
              <Select
                ...
                label="Category"
                onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => setFilterModel(prev => ({ ...prev, category: e.target.value }))}
              >
          ...
          <Grid {...{item: true}} xs={12} md={2}>
            <FormControl fullWidth size="small">
              ...
              <Select
                ...
                label="Status"
                onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => setFilterModel(prev => ({ ...prev, status: e.target.value }))}
              >
          ...
          <Grid {...{item: true}} xs={12} md={2}>
            <FormControl fullWidth size="small">
              ...
              <Select
                ...
                label="Priority"
                onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => setFilterModel(prev => ({ ...prev, priority: e.target.value }))}
              >
      ...
      {/* Error Alert */}
      {error && (
        <Alert severity="error" sx={{ mb: 2 } as any} onClose={() => setError(null)}>
          {error}
        </Alert>
      )}

      {/* Loading Progress */}
      {loading && <LinearProgress sx={{ mb: 2 } as any} />}

      {/* Data Grid */}
      <Paper sx={{ height: 600, width: '100%' } as any}>
        <DataGrid
          rows={features}
          columns={columns}
