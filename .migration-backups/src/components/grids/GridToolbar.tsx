  ...
  return (
    <Box sx={{ 
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: spacing } as any}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flex: 1 } as any}>
          {toolbarConfig.showSearch && (
            <TextField
              size="small"
              placeholder={translate('search', 'Search...')}
              value={searchText}
              onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => handleSearch(e.target.value)}
              sx={{ minWidth: 200, maxWidth: 300 } as any}
              InputProps={{
                startAdornment: (
