...
const EnhancedCmsPagesGrid = () => {
        ...
        try {
            ...
            if (items.length > 0) {
                ...
                setStats({
                    ...
                    recentlyModified: items.filter(item => {
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            renderCell: (params) => (
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 } as any}>
                    <Typography variant="body2" sx={{ fontWeight: 500 } as any}>
                        {params.value}
                    </Typography>
                </Box>
            )
        ...
        },
        {
            ...
            sortable: false,
            renderCell: (params) => (
                <Box sx={{ display: 'flex', gap: 0.5 } as any}>
                    <Tooltip title="Edit">
    ...
    const handlePreview = useCallback((item as any) => {
        setSelectedItem(item);
        setPreviewMode(true);
        setOpenDialog(true);
    }, []);
    ...
    const handleDelete = useCallback(async (id as any) => {
    ...
    // ===== RENDER =====
    return (
        <Box sx={{ p: 3, height: '100%', display: 'flex', flexDirection: 'column' } as any}>
            ...
            <Box sx={{ mb: 3 } as any}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 } as any}>
                    <Typography variant="h4" sx={{ fontWeight: 600 } as any}>
                    ...
                    {statsCards.map((card, index) => (
                        <Grid {...{item: true}} xs={12} sm={6} md={3} key={index}>
                            <Card sx={{
                                ...
                                {/* CardContent area */}
                                <CardContent sx={{ p: 2 } as any}>
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' } as any}>
                                        <Box>
                                            <Typography variant="h4" sx={{ fontWeight: 700, mb: 0.5 } as any} component="div">
                                                {card.value}
                                            </Typography>
                                            <Typography variant="body2" sx={{ opacity: 0.9 } as any} component="div">
                                                {card??.title}
                                            </Typography>
                                            {card.subtitle && (
                                                <Typography variant="caption" sx={{ opacity: 0.8 } as any} component="div">
                                                    {card.subtitle}
                                                </Typography>
                                            )}
                                        </Box>
                                        <Box sx={{ opacity: 0.8 } as any}>
                                            {card.icon}
                                        </Box>
                                    </Box>
                                    {card.percentage !== undefined && (
                                        <Typography variant="caption" sx={{ opacity: 0.9 } as any} component="div">
            ...
            <UnifiedGrid
                {...getStandardGridProps(contentType === 'pages' ? 'cmsPages' : 'cmsBlocks', {
                    ...
                    onDelete: (items) => items.forEach(id => handleDelete(id as any)),
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="md" fullWidth>
                ...
                <DialogContent>
                    <Tabs value={activeTab} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (_, v) => setActiveTab(v as any)} sx={{ mb: 2 } as any}>
                        <Tab label="General" />
                        <Tab label="Content" />
                        <Tab label="SEO" />
                        <Tab label="Advanced" />
                    ...
                    {activeTab === 0 && (
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 } as any}>
                            <TextField label="Title" value={formData??.title} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => e => handleFormChange('title', e.target.value)} fullWidth required />
                            <TextField label="Identifier" value={formData?.?.identifier} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => e => handleFormChange('identifier', e.target.value)} fullWidth required />
                            <FormControlLabel control={<Switch checked={formData??.is_active} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => e => handleFormChange('is_active', e.target.checked)} />} label="Active" />
                        </Box>
                    )}
                    {activeTab === 1 && (
                        <Box sx={{ mt: 2 } as any}>
                            <ReactQuill theme="snow" value={formData??.content} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => v => handleFormChange('content', v)} modules={quillModules} formats={quillFormats} style={{ minHeight: 200 }} />
                        </Box>
                    )}
                    {activeTab === 2 && (
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 2 } as any}>
                            <TextField label="Meta Title" value={formData??.meta_title} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => e => handleFormChange('meta_title', e.target.value)} fullWidth />
                            <TextField label="Meta Description" value={formData??.meta_description} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => e => handleFormChange('meta_description', e.target.value)} fullWidth />
                            <TextField label="Meta Keywords" value={formData??.meta_keywords} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => e => handleFormChange('meta_keywords', e.target.value)} fullWidth />
                        </Box>
                    )}
                    {activeTab === 3 && (
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 2 } as any}>
                            <TextField label="URL Key" value={formData??.url_key} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => e => handleFormChange('url_key', e.target.value)} fullWidth />
                            <TextField label="Sort Order" type="number" value={formData??.sort_order} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => e => handleFormChange('sort_order', Number(e.target.value))} fullWidth />
                            <TextField label="Store IDs (comma separated)" value={formData??.store_id ? formData??.store_id.join(',') : ''} onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => e => handleFormChange('store_id', e.target.value.split(',').map(v => v.trim()).filter(Boolean))} fullWidth />
                        </Box>
                    )}
                </DialogContent>
                <DialogActions>
