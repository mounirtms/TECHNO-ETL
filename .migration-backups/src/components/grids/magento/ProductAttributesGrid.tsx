...
const ProductAttributesGrid = () => {
  ...
  const fetchAttributes = useCallback(async (params = {}) => {
    try {
      ...
      const response = await magentoApi.getProductAttributes(params as any);
...
const AttributeDialog: React.FC<any> = ({ open, onClose, attribute, onSave }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 1 } as any}>
          <TextField
            label="Attribute Code"
            value={formData.attribute_code}
            onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setFormData({ ...formData, attribute_code: e.target.value })}
            disabled={!!attribute}
            fullWidth
          />
          <TextField
            ...
            onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setFormData({ ...formData, frontend_label: e.target.value })}
            fullWidth
          />
          <FormControl fullWidth>
            ...
            <Select
              ...
              onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setFormData({ ...formData, frontend_input: e.target.value })}
            >
          ...
          <FormControl fullWidth>
            ...
            <Select
              ...
              onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setFormData({ ...formData, scope: e.target.value })}
            >
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setFormData({ ...formData, is_required: e.target.checked })}
              />
            }
            label="Required"
          />
