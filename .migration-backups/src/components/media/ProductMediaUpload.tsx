...
const ProductMediaUpload: React.FC<any> = ({ sku, existingImages = [], onImagesChange }) => {
  ...
  const toggleImageType = (type) => {
    ...
    if (updatedImage??.types.includes(type as any)) {
                          ...
                          >
                            ...
                            <CardActions sx={{ p: 1, pt: 0 } as any}>
                              ...
                              <IconButton
                                size="small"
                                color="error"
                                onClick={() => handleDeleteImage(index as any)}
                              >
                                <DeleteIcon />
                              </IconButton>
                            </CardActions>
          ...
          {editDialog.image && (
            <Box>
              <TextField
                ...
                onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => setEditDialog({
                  ...editDialog,
              ...
              <Box sx={{ mb: 2 } as any}>
                {['image', 'small_image', 'thumbnail'].map(type => (
                  <FormControlLabel
                    ...
                    control={
                      <Switch
                        checked={editDialog.image??.types.includes(type as any)}
                        onChange={(e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => (e) => () => toggleImageType(type as any)}
                      />
                    }
