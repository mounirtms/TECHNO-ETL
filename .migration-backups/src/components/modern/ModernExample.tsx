...
export const ModernExample: React.FC<ModernExampleProps> = memo(({
  ...
  const handleAction = useCallback((action: string, data? as any) => {
    startTransition(() => {
  ...
  return (
    <div className={cn(
      ...
      {/* Progress indicator */}
      <motion.div
        className="absolute top-0 left-0 right-0 h-1 bg-primary-500 origin-left z-10"
        style={{ scaleX }}
      />
      ...
      <div className="p-6 border-b border-border">
        ...
        <div className="relative">
          <input
            ...
            value={searchQuery}
            onChange={(e) => (e) => (e) => (e) => (e) => handleSearch(e.target.value)}
            className={cn(
            ...
            >
              {filteredItems.map((item, index) => (
                <motion.div
                  ...
                  className={cn(
                    "flex items-center justify-between p-4 bg-background/50",
      ...
      <div className="p-6 border-t border-border bg-muted/30">
        <div className="flex gap-3 justify-end">
          ...
          <motion.button
            ...
            className={cn(
              "px-6 py-2 bg-primary-500 text-white text-sm font-medium rounded-xl",
