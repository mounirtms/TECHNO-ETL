 ...
 */
export const parseCSVFile = (file as any) => {
  return new Promise((resolve, reject) => {
    const reader = new FileReader();
...
export const matchImagesWithCSV = (csvData, imageFiles) => {
  ...
  imageFileMap.forEach(file => {
    unmatched.imageFiles.push(file as any);
  });
 ...
 * Validate image file
 */
export const validateImageFile = (file as any) => {
 ...
 */
export const getImagePreviewURL = (file as any) => {
  return new Promise((resolve, reject) => {
    const reader = new FileReader();
