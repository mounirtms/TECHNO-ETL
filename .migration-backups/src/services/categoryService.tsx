 ...
 */
export const getCategoryChildren = (parentId: any) => {
  const flatCategories = getAllCategories();
  return flatCategories.filter(cat => cat.parent_id === parseInt(parentId as any));
};

/**
 * Get category path as breadcrumb
 */
export const getCategoryBreadcrumb = (categoryId: any) => {
  const category = findCategoryById(categoryId as any);
  if (!category) return [];
 ...
 */
export const searchCategories = (searchTerm as any) => {
 ...
 */
export const getCategoriesByLevel = (level: any) => {
  const flatCategories = getAllCategories();
 ...
 */
export const formatCategoryForGrid = (category: any) => {
  return {
    ...category,
