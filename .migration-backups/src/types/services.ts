...
export interface SettingsService {
  ...
  validate(settings as any): Promise<ValidationResult>;
}
...
export interface ApiService {
  ...
  addInterceptor(type: 'request' | 'response', interceptor as any): void;
...
export interface LoggerService {
  debug(message: string, meta? as any): void;
  info(message: string, meta? as any): void;
  warn(message: string, meta? as any): void;
  error(message: string, error?: Error, meta? as any): void;
  fatal(message: string, error?: Error, meta? as any): void;
...
export interface ServiceFactory {
  createApiService(config as any): ApiService;
  createCacheService(config as any): CacheService;
  createLoggerService(config as any): LoggerService;
  createAuthService(config as any): AuthService;
  createNotificationService(config as any): NotificationService;
  createFileService(config as any): FileService;
  createSearchService(config as any): SearchService;
  createThemeService(config as any): ThemeService;
  createAnalyticsService(config as any): AnalyticsService;
}
