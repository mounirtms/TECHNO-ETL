...
const ComprehensiveDashboard = () => {
  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 3 }, maxWidth: '100%', overflow: 'hidden', height: '100%', minHeight: 0 }}>
      {/* Dashboard Header */}
      <Fade in timeout={600}>
        <Box sx={{ mb: 4 }}>
      ...
      {/* Charts Section */}
      <Grid container spacing={3} sx={{ mb: 4, minHeight: 400 }}>
        {/* Sales Trend Chart */}
        <Grid item xs={12} lg={8}>
          <Fade in timeout={800}>
            <Paper sx={{ p: 3, height: '100%', minHeight: 400 }}>
              ...
              <Box sx={{ width: '100%', height: 'calc(100% - 50px)', minHeight: 300 }}>
